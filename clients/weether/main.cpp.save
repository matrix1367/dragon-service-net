...
void RefreshDlgMain(TypeParmT parm)
{
    ...
    //CGUIManager::getInstance().ShowMessage("Aktualizacja danych", "Dane zostały pomyślnie zaktualizowane");
}



#ifdef mCTRL
static void SetupCommonChart(HWND hwndChart, DataWeetherNextHours& data)
{
